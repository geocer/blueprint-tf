locals {
  ...
  alb_core_configs = { 
    ...
    access_logs = {
      ...
      enabled = false # Alterado para true para habilitar logs
    }
        ...
        port_mappings = lookup(container_def, "container_port", null) != null ? [
          {
            ...
            protocol      = "tcp"
            name          = tostring(container_def.container_port)
          }
        ] : []

        repository_credentials = (
          lookup(container_def, "repositoryCredentials", null) != null &&
          lookup(container_def.repositoryCredentials, "credentialsParameter", null) != null
          ) ? {
          credentialsParameter = container_def.repositoryCredentials.credentialsParameter
        } : null
